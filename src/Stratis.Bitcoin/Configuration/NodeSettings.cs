...
namespace Stratis.Bitcoin.Configuration
{
    ...
    public class NodeSettings : IDisposable
    {
        ...
        /// </remarks>
        public NodeSettings(Network network = null, int protocolVersion = 0,
            string agent = "StratisBitcoin", string[] args = null)
        {
            ...
            if (this.Network == null)
            {
                ...
                if (protocolVersion == Networks.ProtocolVersion.AltProtocal.Id)
        ...
        public static NodeSettings Default(Network network = null, int protocolVersion = 0)
        {
